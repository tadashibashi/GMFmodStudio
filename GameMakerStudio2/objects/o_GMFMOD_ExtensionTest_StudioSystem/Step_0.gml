...
//	GMFMOD_Assert(GMFMOD_GetError(), FMOD_OK, "EventInstance Stop");
//	stopped = true;
//}
...
//	GMFMOD_Assert(fmod_studio_evinst_get_parameter_by_id(evinst, buf.getAddress()),
//		timer / 20, "Setting and Getting EvInst Param by ID");
//	GMFMOD_Assert(fmod_studio_evinst_get_parameter_by_name(evinst, "RoomSize"), 
